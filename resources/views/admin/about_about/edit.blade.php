...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.about_about') @lang('admin.sidebar.edit')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('about_abouts.update' , $aboutAbout->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_uz" class="form-control {{ $errors->has('title_uz') ? "is-invalid":"" }}" value="{{ $aboutAbout->title_uz }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ru" class="form-control {{ $errors->has('title_ru') ? "is-invalid":"" }}" value="{{ $aboutAbout->title_ru }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control {{ $errors->has('title_en') ? "is-invalid":"" }}" value="{{ $aboutAbout->title_en }}" required>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote18" name="text_uz" class="form-control">
                                            {{$aboutAbout->text_uz}}
                                        </textarea>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote19" name="text_ru" class="form-control">
                                            {{$aboutAbout->text_ru}}
                                        </textarea>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote20" name="text_en" class="form-control">
                                            {{$aboutAbout->text_en}}
                                        </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('about_abouts.index') }}" class="btn btn-default float-left">@lang('admin.crud.cancel')</a>
                            </div>
                        </form>
