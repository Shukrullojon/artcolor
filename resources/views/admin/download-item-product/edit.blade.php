...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.download_item_product') @lang('admin.sidebar.edit')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('adminIndex') }}">@lang('admin.sidebar.home')</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('downloaditemproduct.index') }}">@lang('admin.sidebar.download_item_product')</a></li>
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('downloaditemproduct.update',$product->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        <label>@lang('admin.crud.file')</label><label style="color: red">*</label>
                                        <input type="file" name="file" class="form-control {{ $errors->has('file') ? "is-invalid":"" }}" value="{{ old('file') }}">
                                        @if($errors->has('file'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="filter_id">
                                            @foreach($filters as $filter)
                                                <option @if($product->filter_id == $filter->id) selected @endif value="{{ $filter->id }}">{{ $filter->title_uz }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('downloaditemproduct.index') }}" class="btn btn-default float-left">@lang('admin.crud.cancel')</a>
                            </div>
                        </form>
