...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.download_item_product') @lang('admin.sidebar.add')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('downloaditemproduct.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="file" class="form-control {{ $errors->has('file') ? "is-invalid":"" }}" value="{{ old('file') }}" required>
                                        @if($errors->has('file'))
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('portfolioproduct.index') }}" class="btn btn-default float-left">@lang('admin.crud.cancel')</a>
                            </div>
                        </form>
