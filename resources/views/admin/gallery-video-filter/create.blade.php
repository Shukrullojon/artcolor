...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.gallery_video_filter') @lang('admin.sidebar.add')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('galleryvideofilter.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
