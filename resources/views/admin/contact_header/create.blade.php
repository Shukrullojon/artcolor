            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('contact_headers.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        <label>@lang('admin.crud.button_url')(en)</label><label style="color: red">*</label>
                                        <input type="text" name="button_link" class="form-control {{ $errors->has('button_url') ? "is-invalid":"" }}" value="{{ old('button_url') }}" required>
