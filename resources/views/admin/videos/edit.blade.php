...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.video') @lang('admin.sidebar.add')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('adminIndex') }}">@lang('admin.sidebar.home')</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('videos.index') }}">@lang('admin.sidebar.video')</a></li>
                        <li class="breadcrumb-item active">@lang('admin.crud.video')</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('videos.update' ,$video->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        <label>@lang('admin.crud.video_link')</label><label style="color: red">*</label>
                                        <input type="text" name="link" class="form-control {{ $errors->has('link') ? "is-invalid":"" }}" value="{{ $video->link }}" required>
                                        @if($errors->has('link'))
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('videos.index') }}" class="btn btn-default float-left">@lang('admin.crud.cancel')</a>
                            </div>
                        </form>
