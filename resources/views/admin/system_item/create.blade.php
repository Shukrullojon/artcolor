...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.system_item') @lang('admin.sidebar.add')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('system_items.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                        ...
                                        <label>@lang('admin.crud.system')</label><label style="color: red">*</label>
                                         <select class="form-control" name="system_id" required>
                                              @foreach($systems as $system)
                                                  <option value="{{$system->id}}">{{$system->title_uz}}</option>
                                             @endforeach
                                         </select>
