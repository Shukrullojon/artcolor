...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.portfolio_about') @lang('admin.sidebar.add')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('portfolioabout.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="social_uz" class="form-control {{ $errors->has('social_uz') ? "is-invalid":"" }}" value="{{ old('social_uz') }}" required>
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="social_ru" class="form-control {{ $errors->has('social_ru') ? "is-invalid":"" }}" value="{{ old('social_ru') }}" required>
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="social_en" class="form-control {{ $errors->has('social_en') ? "is-invalid":"" }}" value="{{ old('social_en') }}" required>
