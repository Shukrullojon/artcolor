...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.product_type_item') @lang('admin.sidebar.edit')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('producttypeitem.update',$productTypeItem->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_uz" class="form-control {{ $errors->has('title_uz') ? "is-invalid":"" }}" value="{{ old('title_uz',$productTypeItem->title_uz) }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ru" class="form-control {{ $errors->has('title_ru') ? "is-invalid":"" }}" value="{{ old('title_ru',$productTypeItem->title_ru) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control {{ $errors->has('title_en') ? "is-invalid":"" }}" value="{{ old('title_en',$productTypeItem->title_en) }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        <label>@lang('admin.sidebar.product_type')</label><label style="color: red">*</label>
                                        <select class="form-control" name="product_type_id">
                                            @foreach($types as $type)
                                                <option @if($productTypeItem->product_type_id == $type->id) selected @endif value="{{ $type->id }}">{{$type->title_uz}}</option>
                                            @endforeach
                                        </select>
                                        @if($errors->has('product_type_id'))
                                            <span class="error invalid-feedback">{{ $errors->first('product_type_id') }}</span>
                                        @endif
                                    </div>
                                </div>
