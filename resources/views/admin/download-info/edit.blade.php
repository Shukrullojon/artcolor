...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.download_info') @lang('admin.sidebar.edit')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('downloadinfo.update' , $info->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_uz" class="form-control {{ $errors->has('title_uz') ? "is-invalid":"" }}" value="{{ $info->title_uz }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ru" class="form-control {{ $errors->has('title_ru') ? "is-invalid":"" }}" value="{{ $info->title_ru }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control {{ $errors->has('title_en') ? "is-invalid":"" }}" value="{{ $info->title_en }}" required>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote" name="info_uz" class="form-control">{!! $info->info_uz !!}</textarea>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote1" name="info_ru" class="form-control">{!! $info->info_ru !!}</textarea>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote2" name="info_en" class="form-control">{!! $info->info_en !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('downloadabout.index') }}" class="btn btn-default float-left">@lang('admin.crud.cancel')</a>
                            </div>
                        </form>
