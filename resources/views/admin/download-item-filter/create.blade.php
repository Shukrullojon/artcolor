...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.download_item_filter') @lang('admin.sidebar.add')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('downloaditemfilter.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type">
                                            <option value="1">@lang('admin.crud.effect')</option>
                                            <option value="2">@lang('admin.crud.product')</option>
                                        </select>
                                        @if($errors->has('type'))
