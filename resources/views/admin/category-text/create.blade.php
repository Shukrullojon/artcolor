...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.category_text') @lang('admin.sidebar.add')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('categorytext.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote" name="info_uz" class="form-control">
                                        </textarea>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote1" name="info_ru" class="form-control">
                                        </textarea>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote2" name="info_en" class="form-control">
                                        </textarea>
