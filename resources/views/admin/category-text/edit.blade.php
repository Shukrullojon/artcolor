...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('admin.sidebar.category_text') @lang('admin.sidebar.edit')</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('categorytext.update',$categoryText->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_uz" class="form-control {{ $errors->has('title_uz') ? "is-invalid":"" }}" value="{{ old('title_uz',$categoryText->title_uz) }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ru" class="form-control {{ $errors->has('title_ru') ? "is-invalid":"" }}" value="{{ old('title_ru',$categoryText->title_ru) }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control {{ $errors->has('title_en') ? "is-invalid":"" }}" value="{{ old('title_en',$categoryText->title_en) }}" required>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote" name="info_uz" class="form-control">{!! $categoryText->info_uz !!}</textarea>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote1" name="info_ru" class="form-control">{!! $categoryText->info_ru !!}</textarea>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" id="summernote2" name="info_en" class="form-control">{!! $categoryText->info_en !!}</textarea>
