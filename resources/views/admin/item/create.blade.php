            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('team.index') }}">@lang('admin.sidebar.about_item')</a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="count" class="form-control {{ $errors->has('count') ? "is-invalid":"" }}" value="{{ old('count') }}" required>
                                        @if($errors->has('count'))
