                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="additional_uz" class="form-control {{ $errors->has('additional_uz') ? "is-invalid":"" }}" value="{{ old('additional_uz') }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="additional_ru" class="form-control {{ $errors->has('additional_ru') ? "is-invalid":"" }}" value="{{ old('additional_ru') }}" required>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="additional_en" class="form-control {{ $errors->has('additional_en') ? "is-invalid":"" }}" value="{{ old('additional_en') }}" required>
