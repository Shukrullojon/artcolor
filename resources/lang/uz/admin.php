...
return [
    'sidebar' => [
        ...
        "portfolio_about" => "Portfolio haqida",
        "portfolio_header" => "Portfolio sarlavha",
        ...
        'system_product' => "Tizim mahsuloti" ,
        'system_slider' => "Tizim slayderi" ,
        'system_about' => "Tizim haqida" ,
        'about' => "Kompaniya haqida" ,
        'about_item' => "Element haqida" ,
        'activity' => "Faoliyat" ,
        'videos' => "Video lavhalar" ,
        "download_item" => "Yuklash elementlari",
        "download_item_filter" => "Filtr",
